#!/usr/bin/env python3
"""One-off migration: add the Moonshot (Kimi) provider + kimi-k2 model.
...
Moonshot existed therefore won't contain it. This script inserts just the
Moonshot rows into the existing catalog without disturbing anything else.
...
Usage:
    python scripts/add_moonshot_model.py
"""
...
if __name__ == "__main__":
    print("=" * 50)
    print("Add Moonshot (Kimi) model to AI catalog")
    print("=" * 50)
    migrate()
